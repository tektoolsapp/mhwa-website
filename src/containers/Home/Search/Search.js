  ...
  return (
    <BannerWrapper>
      ...
      >
        <>
          <GlideSlide>
            <img src="/images/banner/scarborough-beach-2.jpg" alt="Banner 1" />
          </GlideSlide>
          <GlideSlide>
            <img src="/images/banner/scarborough-beach-1.jpg" alt="Banner 2" />
          </GlideSlide>
          <GlideSlide>
            <img src="/images/banner/scarborough-beach-4.jpg" alt="Banner 3" />
          </GlideSlide>
        </>
      </GlideCarousel>
